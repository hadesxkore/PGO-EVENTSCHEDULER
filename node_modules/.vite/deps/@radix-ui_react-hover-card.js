...
import {
  ...
  size,
  useFloating
} from "./chunk-VR5HNF4D.js";
import {
  Portal,
  useEscapeKeydown
} from "./chunk-54STGTA5.js";
import {
  useCallbackRef
} from "./chunk-LU722NYQ.js";
import {
  useSize
} from "./chunk-26IGGKBH.js";
import {
  useControllableState
} from "./chunk-2WR3GSFD.js";
import {
  createContextScope,
  useLayoutEffect2
} from "./chunk-T47NQJ5C.js";
import {
  Primitive,
  dispatchDiscreteCustomEvent
} from "./chunk-EDAHZL4K.js";
import {
  useComposedRefs
} from "./chunk-S4ZML3GJ.js";
import "./chunk-WDC2E55P.js";
import {
  require_jsx_runtime
...
// node_modules/@radix-ui/react-hover-card/node_modules/@radix-ui/react-popper/dist/index.mjs
...
// node_modules/@radix-ui/react-hover-card/node_modules/@radix-ui/react-presence/dist/index.mjs
...
var HoverCard = (props) => {
  ...
  const hasSelectionRef = React5.useRef(false);
  const isPointerDownOnContentRef = React5.useRef(false);
  ...
  const handleDismiss = React5.useCallback(() => setOpen(false), [setOpen]);
  React5.useEffect(() => {
    return () => {
      clearTimeout(openTimerRef.current);
      clearTimeout(closeTimerRef.current);
...
var HoverCardTrigger = React5.forwardRef(
  (props, forwardedRef) => {
...
var HoverCardContentImpl = React5.forwardRef((props, forwardedRef) => {
  const {
    __scopeHoverCard,
    onEscapeKeyDown,
    onPointerDownOutside,
  ...
  const composedRefs = useComposedRefs(forwardedRef, ref);
  const [containSelection, setContainSelection] = React5.useState(false);
  React5.useEffect(() => {
    if (containSelection) {
...
var HoverCardArrow = React5.forwardRef(
  (props, forwardedRef) => {
