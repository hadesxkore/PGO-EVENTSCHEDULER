  ...
  return (
    <div className="space-y-2">
      <div className={cn(
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button
              ...
              className={cn(
                ...
                isBulletActive && (isDarkMode ? "bg-slate-700" : "bg-gray-200"),
                isDarkMode ? "hover:bg-slate-700 text-gray-100" : "hover:bg-gray-200 text-gray-900"
              )}
              title="Toggle bullet points"
            >
              <List className={cn("h-4 w-4", isDarkMode ? "text-gray-100" : "text-gray-900")} />
              <ChevronDown className={cn("h-3 w-3", isDarkMode ? "text-gray-100" : "text-gray-900")} />
            </Button>
          </DropdownMenuTrigger>
          <DropdownMenuContent align="start" className={cn(
            ...
            <DropdownMenuItem 
              onClick={() => { setBulletStyle('dot'); handleBulletClick(); }}
              className={isDarkMode ? "text-gray-100 focus:bg-slate-800" : "text-gray-900 focus:bg-gray-100"}
            >
              • Bullet Point
            </DropdownMenuItem>
            <DropdownMenuItem 
              onClick={() => { setBulletStyle('dash'); handleBulletClick(); }}
              className={isDarkMode ? "text-gray-100 focus:bg-slate-800" : "text-gray-900 focus:bg-gray-100"}
            >
              – Dash
            </DropdownMenuItem>
            <DropdownMenuItem 
              onClick={() => { setBulletStyle('number'); handleBulletClick(); }}
              className={isDarkMode ? "text-gray-100 focus:bg-slate-800" : "text-gray-900 focus:bg-gray-100"}
            >
              1. Numbering
            </DropdownMenuItem>
        ...
        <Button
          ...
          className={cn(
            "h-8 w-8 p-0",
            isDarkMode ? "hover:bg-slate-700 text-gray-400 hover:text-red-400" : "hover:bg-gray-200 text-gray-500 hover:text-red-500"
          )}
      ...
      <div
        ...
        className={cn(
          "min-h-[140px] rounded-lg border p-3 focus:outline-none focus:ring-2 focus:ring-offset-2 text-base",
          isDarkMode 
            ? "bg-slate-900 border-slate-700 focus:ring-slate-700 focus:ring-offset-slate-900 text-gray-100" 
            : "bg-white border-gray-200 focus:ring-gray-200 focus:ring-offset-white text-gray-900",
